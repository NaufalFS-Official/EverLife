# GAME BLUEPRINT: EverLife (v1.1 - REVISED)
**Role**: Senior Game Designer & Software Architect  
**Dokumen Induk**: `docs/game_prd_v1.1.md` (LOCKED)  
**Status**: REVISED (Menunggu Kata "APPROVED" dari Pengguna)
...
| **Konektivitas** | C0 (Offline Penuh, Local Client-Side Execution) [REV: Q3: Siap provider cloud standby] | [U] |
...
| **Engine & Framework** | Web-Native SPA: React 19.3.0 + Vite 8.3.1 + Tailwind CSS 4.3.3 + Lucide Icons [REV: Q2, Q10] | [U] |
...
| `GAMEPLAY_ACTIVE` | `SUBMENU_OPEN` | Tap salah satu tab bawah (Job, Assets, Relasi, Aktivitas) saat tidak ada modal | **SAH** | N/A | Klien [U] |
...
| `DEATH_SUMMARY` | `GAMEPLAY_ACTIVE` | Mencoba kembali bermain dengan karakter yang sudah mati [REV: Permadeath locked] | **TERLARANG** | Tombol "+Age" dan tab dinonaktifkan permanen; hanya ada tombol New Life | Klien [U] |
...
### 5.1 Layering Modular & Pure Dependencies [REV: Q10]
Dependensi runtime dikunci murni client-side: `react`, `react-dom`, `lucide-react`, `canvas-confetti`, `howler`.

```
src/
├── core/                   # 100% Pure TypeScript (Zero DOM, zero UI dependencies, runnable in Node.js)
...
│
├── adapter/                # Platform adapters & storage repositories [REV: Q3]
...
## S6. ASET & PIPELINE PENYEDIAAN [REV: Q5]

> Pipeline Campuran: Generator SVG modular internal (P), Pustaka Ikon Lucide (H/MIT), Efek Suara CC0 (H).
...
## S8. PERSISTENSI, REPOSITORY PATTERN & SAVE DATA [REV: Q3, Q8]

### 8.1 Abstraksi Repository Pattern (Standby Migration C1/C2)
...
* **Enkripsi Integritas Lokal [REV: Q8]**: Setiap save diselimuti envelope ber-salted SHA-256 HMAC untuk mendeteksi manipulasi lokal sembarangan.
...
## S14. HOSTING, CI/CD & OBSERVABILITAS [REV: Q9]
...
* **Feature Flagging**: Fitur baru (misal Crime / Assets) dibungkus boolean flags di config.
* **Rollback Strategy**: 1-Click Rollback via Cloudflare Pages deployment history.

---

## S17. PLATFORM, DEVICE & LEGAL [REV: Q7]

### 17.1 Matriks Uji Perangkat Fisik (Level L5) [REV: Q7]
...
## S18. MATRIKS TRACEABILITY & ALOKASI SESI [REV: Q4, Q6]

| Fitur ID | Nama Fitur | Kategori | Modul Pemilik | Sesi [REV: Q4] | Agent Penanggung Jawab | AC ID | Test ID | Path Berkas Tes | Level |
| --- | --- | --- | --- | --- | --- | --- | --- | --- | --- |
